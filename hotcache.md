...
Last updated: 2026-04-28 (Peter Gostev What Models Still Suck At ingest)

## Wiki state

- **56 sources ingested**, **87 concept pages**, **70 entity pages**, **0 analysis pages** (all indexed)
...
wiki/
  ...
  sources/              # One summary per ingested source (54 files)
  entities/             # People, orgs, products (65 files)
  concepts/             # Ideas, frameworks, themes (80 files)
