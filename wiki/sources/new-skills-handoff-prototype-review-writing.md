...
## สถานะหลัง Skills v1.1

[[new-skills-v1-1-wayfinder-research-implement-to-spec-to-tickets|Skills v1.1]] เปลี่ยน claim ที่เป็น “กำลังทำ” บางส่วนของ changelog นี้:

- `/review` ถูกนำมาใช้จริงใน lifecycle แล้ว ยังตรวจ standards กับ spec เป็นสองแกน และเพิ่ม refactoring smells
- `/to-PRD` เปลี่ยนชื่อเป็น `/to-spec`
- `/to-issues` เปลี่ยนชื่อเป็น `/to-tickets`
- `/prototype` กลายเป็น ticket type ที่ [[wayfinding]] เรียกใช้ก่อน spec

ข้อมูลเดิมยังเก็บไว้เพราะมันบอกสถานะ ณ วันที่วิดีโอแรกเผยแพร่. ส่วนรายการนี้คือสถานะที่ผู้สร้างประกาศใน v1.1.
