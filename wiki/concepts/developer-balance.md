...
## Workplace AI และ AI Brain Fry

[[techsauce|Techsauce]] สรุปงานเรื่อง [[ai-brain-fry|AI Brain Fry]] ว่า AI อาจทำให้คนเหนื่อยกว่าเดิม ถ้างานกลายเป็นการคุม ตรวจ และสลับหลาย AI tool ตลอดเวลา. นี่เป็นหลักฐานฝั่ง workplace ที่เสริมกรอบ Developer Balance: ไม่ใช่แค่นักพัฒนาที่เจอปัญหา agent เยอะเกิน review rate แต่คนทำงานทั่วไปก็เจอ oversight load แบบเดียวกัน.

บทเรียนคืออย่าเอา productivity จาก AI ไปวัดแค่ output. ต้องวัดด้วยว่า workflow ใหม่ทำให้คนใช้สมองมากขึ้นหรือน้อยลง. ถ้า AI ทำ routine tasks และมี gate ตรวจง่าย มันช่วยลด burnout. ถ้า AI เพิ่มจำนวนสิ่งที่คนต้องรับผิดชอบพร้อมกัน มันอาจสร้าง [[orchestration-tax|orchestration tax]] และลากไปสู่ [[cognitive-surrender|cognitive surrender]].
...
เขาชอบ agent ในฐานะคู่คิดมากกว่า: pair programmer ที่ช่วยถาม ช่วยให้พูดปัญหาออกมา และช่วยสำรวจ solution space. กองทัพ agent ที่ทำให้คนไม่คิดปัญหาด้วยตัวเองจึงสวนทางกับ balance.
