...
[[addy-osmani|Addy Osmani]] เล่าเรื่องเดียวกันด้วยภาษา concurrency ใน [[orchestration-tax|Orchestration Tax]]: เปิด agent (producer) ได้ไม่จำกัด แต่คน review/merge (consumer) มีคนเดียวและทำงานทีละอย่าง คอขวดเลยอยู่ที่ judgement ของมนุษย์ — และถ้าฝืนเร็วเกินไป acceptance จะกลายเป็น [[cognitive-surrender|cognitive surrender]] (รับ ๆ ไปเพราะไม่เหลือ attention จะคิดเอง)
