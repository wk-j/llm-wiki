...
title: Effort Levels
type: concept
tags: [ai, claude, openai, performance, cost-optimization]
created: 2026-04-16
updated: 2026-07-12
sources: [Introducing Claude Opus 4.7.md, Whats new in Claude Opus 4.7 - Anthropic Docs.md, Claude Opus 4.7 Isn't a Drop-in Replacement for 4.6.md, Piyalitt Ittichaiwong - Opus 4.8 Launch Recap.md, gpt-5-6-and-openai-build-week-aimeowyak.md]
---

# Effort Levels / ระดับความพยายาม

พารามิเตอร์ที่ให้ผู้ใช้แลกระหว่าง **คุณภาพการให้เหตุผล (reasoning quality) กับ latency และค่า token** ผู้เรียกใช้เลือกระดับ แล้ว model จัดสรรเวลา/compute ในการคิดให้ตามนั้น หน้านี้เริ่มจากระบบของ [[anthropic|Anthropic]] บน [[claude|Claude]] และเพิ่ม field report ของ [[openai|OpenAI]] เมื่อ GPT-5.6 เปิดให้ใช้

## GPT-5.6: effort กลายเป็นแกนเลือก model อีกชั้น

[[gpt-5-6-and-openai-build-week-aimeowyak|ไลฟ์รีวิว GPT-5.6]] ระบุ 6 ระดับคือ `light`, `medium`, `high`, `extra high`, `max` และ `ultra` แล้วเสนอ heuristic ว่า ถ้าเคยใช้ GPT-5.5 ที่ effort ระดับหนึ่ง ให้ลองลดลงหนึ่งขั้นบน GPT-5.6 ก่อน

คำแนะนำนี้มาจากประสบการณ์ของผู้พูด ไม่ใช่เอกสาร OpenAI จุดที่มีประโยชน์กว่าชื่อ tier คือการคิดเป็นสามแกนพร้อมกัน: **variant × effort × workload** เช่น Luna effort สูงอาจคุ้มกับ implementation แต่ `ultra` บนรุ่นใหญ่สามารถ spawn subagent จำนวนมากจน RAM/token พุ่ง

**ได้อะไร:** อย่าถือ effort สูงสุดเป็นค่าเริ่มต้น ให้เริ่มจากระดับที่พอใช้ แล้ว escalate เมื่อผลยังไม่ผ่านเกณฑ์
