...
created: 2026-04-21
updated: 2026-06-11
sources: [Remote Control - Claude Code Docs.md, How to Keep Shipping When You Walk Away from Your Desk — Zack Proser, WorkOS.md]
---
...
[[zack-proser|Zack Proser]] แสดง use case ที่ขยายจากเรื่อง convenience ไปเป็น [[developer-balance|Developer Balance]]: เริ่ม agent ที่โต๊ะแล้วลุกไปเดิน ใช้มือถือบน LTE steer session เดิมเมื่อได้ insight ใหม่. Agent ยังเดินงานต่อ ส่วนคนเปลี่ยนจาก focus mode ไปเป็น diffuse thinking และลดเวลานั่งโต๊ะ. แต่ Remote Control ต้องไม่กลายเป็นข้ออ้างให้ทำงานตลอดเวลา.
