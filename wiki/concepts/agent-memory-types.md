...
created: 2026-06-26
updated: 2026-07-04
sources: [Self Learning for Agents Clearly Explained.md, stop-building-ai-agents-old-way.md]
---
...
## เชื่อมกับ session mining

[[session-mining|Session mining]] ใน [[stop-building-ai-agents-old-way]] เป็นทางปฏิบัติที่แปลง episodic memory เป็น procedural memory. เราเริ่มจาก run เก่า: test พังแบบเดิม, agent เดิน wrong path เดิม, หรือคนต้องแก้ convention เดิม. พอ pattern ชัด ก็เขียนกลับเป็น rule, eval, hook, หรือ project instruction.

**ได้อะไร:** memory ไม่ได้มีไว้ให้ agent "จำ" อย่างเดียว แต่มีไว้ให้ harness ดีขึ้นจากประสบการณ์จริง.
...
- **[[session-mining]]** — วิธีขุด run เก่าเพื่อกลั่น episodic memory เป็น procedural rule
