...
created: 2026-04-16
updated: 2026-07-05
sources: [advisor-strategy.md, Introducing Claude Opus 4.7.md, alex-ker-harnesses-optimize.md, fables-judgement-simon-willison.md]
---
...
## รุ่นที่ model เลือก model เอง

Advisor strategy ในหน้านี้เป็น pattern ระดับ API/สถาปัตยกรรมที่ *คน* ออกแบบว่าใครเป็น advisor ใครเป็น executor. [[fables-judgement-simon-willison|โพสต์ของ Simon Willison]] (2026-07) แสดงรุ่นที่สั่งด้วย prompt ล้วน ๆ: บอก [[fable|Fable]] หรือ Claude Code ว่า "งาน coding ให้เลือก model ที่ถูกลงเอง แล้วรันใน subagent". model กลายเป็นคนตัดสินว่างานไหนควรส่งให้ตัวถูกกว่า — main loop เก็บ judgment/review ไว้เอง. เป็นการย้ายการเลือก model จากคน (ดู [[model-choice-by-expertise]]) ไปเป็นดุลพินิจของ model ([[judgement-based-prompting]]).
