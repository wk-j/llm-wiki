...
## เดโม GPT-5.6: รันนานเป็นสัปดาห์ แต่ artifact ยังต้องตรวจ

[[gpt-5-6-sol-fable-killer-prompt-engineering|รีวิว GPT-5.6 Sol]] ของ [[prompt-engineering|Prompt Engineering]] ยกเคส early tester ให้ model สร้าง Manhattan แบบ voxel แล้วปล่อยวนเกือบหนึ่งสัปดาห์. ภาพที่ได้ละเอียดและดูตรงกับเมืองจริง ผู้พูดจึงใช้เป็นตัวอย่างว่า well-specified goal ทำให้ model เดิน loop ได้นาน.

แต่ demo ตัวติดตาม ISS ของผู้พูดเองให้ภาพอีกด้าน: ตำแหน่งสถานีดูถูก แต่แผนที่โลกแสดงทวีปไม่ครบ. นี่คือคำเตือนว่า runtime ยาวกับ output ที่ดูอลังการยังไม่ใช่ stop condition. Loop ต้องมี checker แยกตามมิติ เช่น data accuracy, visual completeness และ cross-browser rendering.

**ผลคือ:** ยิ่ง model อยู่ใน loop ได้นาน acceptance criteria ยิ่งต้องแตกเป็นหลักฐานที่ตรวจได้ ไม่งั้นลูปอาจขัดเงางานผิดได้นานขึ้นเหมือนกัน.
