...
created: 2026-04-15
updated: 2026-06-05
sources: [software-engineer-role-ai-era.md, Using Claude Code Session Management & 1M Context.md, llm-era-computer-engineering-nattee.md, alex-ker-harnesses-optimize.md, "New Skills! handoff, prototype, review and writing-*  Skills Changelog.md", Mellum2 Goes Open Source A Fast Model for AI Workflows  The JetBrains AI Blog.md]
---
...
- [[focal-models|Focal models]] — model เฉพาะทางที่เร็วและถูกพอสำหรับ routing, summarization, validation, หรือ subagent ขั้นย่อย เช่น [[mellum2|Mellum2]] ของ [[jetbrains|JetBrains]]

**ผลคือ:** orchestrator ไม่ได้เลือกแค่ว่า "agent ไหนทำงาน" แต่ต้องเลือกด้วยว่า "ขั้นนี้ควรใช้ model แบบไหน" เพื่อคุม latency, throughput, และ cost ของทั้งระบบ
