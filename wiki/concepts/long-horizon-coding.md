...
[[genebench-pro|GeneBench-Pro]] ไม่ใช่ coding benchmark แต่เป็นญาติทางความคิดของ long-horizon coding: ให้ agent เจอ workspace, data files, prompt สั้น, และโจทย์ที่ต้อง iterate เองหลายรอบ ต่างกันตรงที่ "งานที่ถูกต้อง" ไม่ใช่ patch ที่ test ผ่าน แต่เป็น analysis path ทางวิทยาศาสตร์ที่จัดการ ambiguity, QC, causal inference, และ downstream decision ได้ดี

ผลคือ benchmark ยุคใหม่กำลังขยับจากการถามว่า model ทำ task สั้น ๆ ได้ไหม ไปสู่การถามว่า model ปิด loop งานจริงได้ไหม
