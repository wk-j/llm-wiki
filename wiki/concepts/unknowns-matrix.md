...
created: 2026-07-04
updated: 2026-07-12
sources: [a-field-guide-to-fable-finding-your-unknowns.md, piyalitt-codex-keynote-attention-not-token.md, wayfinder-skill.md]
---
...
## สรุปภาษาไทยในโพสต์ Piyalitt (2026-07)

[[piyalitt-codex-keynote-attention-not-token]] เปิดด้วยสรุป frame เดียวกันก่อนเข้า keynote Codex — เน้นว่ายิ่ง model เก่ง ทักษะที่คุ้มลงทุนคือ **รู้จักสิ่งที่ยังไม่รู้** ไม่ใช่แค่สั่งให้เก่งขึ้น. ตัวอย่าง color grading ในวิดีโอ launch Fable: ไม่สั่ง AI ทำมั่ว แต่ให้สอนก่อนเพื่อให้รู้ว่า "ดี" หน้าตาเป็นยังไง — เป็น unknown unknown ที่กลายเป็น known unknown ก่อนลงมือ

เชื่อมกับ [[attention-bottleneck]]: attention ที่เผาไปกับการแก้งานที่ unknowns ยังไม่เคลียร์ แพงกว่าการใช้ explainer/brainstorm/interview ตอนต้น
...
## จาก matrix ไปเป็น issue map

[[wayfinding]] ของ [[matt-pocock|Matt Pocock]] ทำให้ unknowns กลายเป็น state บน issue tracker. ถ้าตั้งคำถามได้ชัดแล้ว แม้ยังตอบไม่ได้ ให้สร้าง ticket. ถ้ายังรู้แค่ว่า “แถวนี้มีเรื่องต้องกลับมาดู” แต่ถามให้คมไม่ได้ ให้อยู่ใน `Not yet specified` หรือ fog ก่อน. พอ frontier ticket ถูกปิด fog บางส่วนจึงค่อยแตกเป็นคำถามใหม่.

ตรงนี้ช่วยกัน false certainty: agent ไม่ต้องสร้าง task ละเอียดยาว ๆ เพื่อกลบ unknown unknowns. แต่ก็ไม่ปล่อย known unknowns ลอยอยู่ในโน้ต เพราะทันทีที่คำถาม precise มันควรมี ticket และ dependency ชัด.

**ได้อะไร:** ตาราง unknowns ไม่จบแค่การวิเคราะห์ แต่มีทางเดินว่าจะเก็บและเปลี่ยน unknown แต่ละชนิดอย่างไรข้ามหลาย session.
