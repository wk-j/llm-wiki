...
created: 2026-05-09
updated: 2026-07-04
sources: [thariq-html-effectiveness.md, fundamental-productivity-ai-world.md, a-field-guide-to-fable-finding-your-unknowns.md]
---
...
## HTML artifact เป็นสื่อสำหรับหา unknowns

ใน [[field-guide-to-fable-finding-unknowns|A Field Guide to Fable]] (2026-07) Thariq ยกระดับ use case: แทบทุกเทคนิคหา [[unknowns-matrix|unknowns]] ของเขาใช้ HTML artifact เป็นสื่อ — หน้าเดียวที่มี 4 design directions ให้ react, implementation plan ที่เรียง decision ที่น่าจะแก้ไว้บนสุด, pitch/explainer สำหรับขอ buy-in, และ HTML report ที่ปิดท้ายด้วย quiz ที่ต้องตอบผ่านก่อน merge (เขาทำ [example artifacts](https://thariqs.github.io/html-effectiveness/unknowns/) ประกอบไว้ด้วย)

ผลคือ: HTML artifact ไม่ได้แค่ช่วยให้อ่านง่ายขึ้น แต่กลายเป็นเครื่องมือหลักของการเคลียร์ช่องว่างระหว่าง [[map-vs-territory|แผนที่กับพื้นที่จริง]] ก่อนที่มันจะแพง
