...
## เคส Bun: จาก claim เป็น field report

[[bun-in-rust|Bun in Rust]] ทำให้ dynamic workflows มีตัวอย่างจริงที่หนักกว่าเดโมเปิดตัว. [[jarred-sumner|Jarred Sumner]] ใช้ [[claude-code|Claude Code]] กับ [[fable|Claude Fable 5]] rewrite [[bun|Bun]] จาก [[zig|Zig]] เป็น [[rust|Rust]] ใน 11 วัน โดยมี workflow ราว 50 ตัว, peak ประมาณ 64 Claudes พร้อมกัน, 6,502 commits ใน branch port และ diff ที่ merge เข้าไปเพิ่มสุทธิราว 1,009,272 lines.
