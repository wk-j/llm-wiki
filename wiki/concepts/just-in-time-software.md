...
[[thorsten-ball|Thorsten Ball]] ใน [[software-after-software|Software After Software]] ข้อ 7.2 ยก just-in-time software ในระดับอุตสาหกรรม:

> "More software will be built just-in-time than ahead of time. Less pre-built software will be required."

ในมุม Ball, ถ้าซอฟต์แวร์ที่ลูกค้าต้องการสามารถ "talked into existence" ได้ vendor ที่ขาย pre-built software ที่ทำ workflow ทั่วไปจะถูก [[value-migration-from-code|value migration]] บีบ เพราะ moat คือ "ลูกค้าสร้างเองไม่คุ้ม" ซึ่งหดลงตามต้นทุนของ agent

TJ DeVries ทำ demo ในระดับ Neovim function (small scope) — Ball ขยาย claim ไปถึง enterprise software ทั้งหมด
