...
## Deep audit harness: Fable

[[aom-fable-elysia-2-audit|โพสต์ของ Aom]] เพิ่มตัวอย่างอีกแบบ: [[fable|Fable]] อาจไม่ได้ชนะเพราะ model เดี่ยวอย่างเดียว แต่เพราะ harness ยอมรันงาน audit แบบยาว, เปิด auto mode, และแตก agent เกือบ 100 ตัวเพื่ออ่าน [[elysia-2|Elysia 2]]. Output ที่ Aom เล่าคือ report 104 ข้อที่ละเอียดพอจะเปลี่ยน release confidence.

นี่เป็นกรณีที่แยก model กับ harness สำคัญมาก. ถ้า Opus 4.8, Fugu Ultra, และ GLM 5.2 บอกว่า "พร้อม" แต่ Fable บอกว่า "ยังไม่พร้อม" เราต้องถามต่อว่าอะไรต่างกัน: model, prompt, tool access, token budget, agent fan-out, memory, หรือ review workflow.
