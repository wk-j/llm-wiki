...
## ความสัมพันธ์กับ Opus 4.7 / Opus 4.8
...
- Mythos Preview อยู่ในระดับที่**สูงกว่า** Opus 4.7 ในแง่ของความสามารถดิบ แต่ต่ำกว่าในแง่ของความปลอดภัย — น่าสนใจว่า [[claude-opus-4-8|Opus 4.8]] ดึง **alignment** เข้าใกล้ระดับ Mythos แล้ว (misaligned behavior ต่ำกว่า 4.7 มาก) แม้ความสามารถดิบยังเป็นคนละ tier
- **อัปเดต timeline (28 พ.ค. 2026, จากบทความเปิดตัว [[claude-opus-4-8|Opus 4.8]]):** "Claude Opus model ที่กำลังจะมาถึง" ที่เคยพูดถึงก็คือ **Opus 4.8** นี่เอง ตอนนี้องค์กรจำนวนหนึ่งใช้ Mythos Preview สำหรับงาน cybersecurity อยู่แล้วภายใต้ [[project-glasswing|Project Glasswing]] และมาตรการป้องกันที่จำเป็น "คืบหน้าอย่างรวดเร็ว" — Anthropic คาดว่าจะ **นำโมเดลระดับ Mythos มาให้ลูกค้าทุกคนได้ภายในไม่กี่สัปดาห์ข้างหน้า**
