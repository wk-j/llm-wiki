...
[[jarred-sumner|Jarred Sumner]] ใช้ Claude Code ในสเกลหนักกว่านั้นใน [[bun-in-rust|Bun in Rust]]: rewrite [[bun|Bun]] จาก [[zig|Zig]] เป็น [[rust|Rust]] ผ่าน workflow ราว 50 ตัว, peak ประมาณ 64 Claudes พร้อมกัน, มี [[adversarial-review-loops|adversarial reviewers]] และ test/CI/fuzzing เป็น gate. นี่เป็นเคสที่ Claude Code ทำหน้าที่เป็น agent fleet/harness สำหรับ [[large-scale-changes|large-scale change]] ไม่ใช่แค่ terminal assistant.
