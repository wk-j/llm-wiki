...
- **[[html-artifacts|HTML Artifacts]]** — เทคนิคการใช้ HTML เป็นสื่อกลางในการสื่อสารเพื่อเพิ่มความชัดเจนและความหนาแน่นของข้อมูล (เสนอโดย Thariq S. จากทีม Claude Code)
