...
created: 2026-04-17
updated: 2026-05-23
sources: [vim-pack-guide.md, software-writing-software-gone-right.md]
---
...
## AI เป็น extension surface

ใน [[software-writing-software-gone-right|Software Writing Software (gone right!)]], [[tj-devries|TJ DeVries]] ใช้ Neovim เป็นฐานของ [[personalized-development-environment|personalized development environment]]. ตัวอย่าง [[luaai-nvim|luai.nvim]] ผูก LLM เข้ากับ Lua module system: ถ้าเรียก function ที่ไม่มีอยู่ plugin จะ generate Lua implementation, save ลง runtime path, แล้วโหลดซ้ำได้เหมือน module ปกติ

จุดนี้ทำให้ Neovim ไม่ได้เป็นแค่ editor ที่มี plugin เยอะ แต่เป็น surface สำหรับ [[just-in-time-software|just-in-time software]]: command ส่วนตัวเล็ก ๆ ที่สร้างตอนต้องใช้ และค่อย ๆ improve จาก error หรือ prompt history ได้
