...
> [!IMPORTANT]
> **Formatting Mandate:**
> 1. **Bilingual H1 is REQUIRED** for all pages except source summaries. Format: `# English Name / ชื่อภาษาไทย`.
> 2. **Thai-Primary Narrative** is REQUIRED for Concept, Entity, and Analysis pages.
> 3. **Raw Sources MUST be saved** to `raw/` before ingestion.
> 4. **English Metadata** (filenames, YAML titles/tags, index entries) must stay English.
